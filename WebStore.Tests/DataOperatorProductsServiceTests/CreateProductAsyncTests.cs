namespace WebStore.Tests.DataOperatorProductsServiceTests
{
    ...
    public class CreateProductAsyncTests
    {
        ...
        [TestMethod]
        public async Task CreateProductAsync_WithProperModel_ShouldReturnTrue()
        {
        ...
        [TestMethod]
        public async Task CreateProductAsync_WithWrongModel_ShouldReturnTrue()
        {
            var categoriesService = new DataOperatorCategoriesService(this.dbContext, this.mapper);
            var service = new DataOperatorProductsService(this.dbContext, this.mapper, categoriesService);
        ...
        [TestMethod]
        public async Task CreateProductAsync_WithNullModel_ShouldReturnFalse()
        {
            var categoriesService = new DataOperatorCategoriesService(this.dbContext, this.mapper);
            var service = new DataOperatorProductsService(this.dbContext, this.mapper, categoriesService);

            ProductBindingModel model = null;
